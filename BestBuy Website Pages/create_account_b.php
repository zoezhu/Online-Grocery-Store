    ...
    <p>Please continue the sign-up process by completing the next part of the form below.</p>
        ...
        <table class="w3-table-all" style="width:700px;">
            ...
            <tr class="w3-table-all tr">
                ...
                <th><input type="text" name="business_category" required style="width:530px;height:35px;"></th>
                    
            </tr>
            <tr class="w3-table-all tr">
                <th style="width:120px;vertical-align:middle;color:#666666;">Company GAI</th>
                <th><input type="number" name="company_gai" min=0 required style="width:530px;height:35px;"></th> 
            </tr>
            <tr class="w3-table-all tr">
            ...
            // check connection
                ...
                <tr class="w3-table-all tr">
                <th style="width:120px;vertical-align:middle;color:#666666;">Building</th>
