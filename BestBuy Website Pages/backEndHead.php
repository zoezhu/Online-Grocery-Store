...
<div class="w3-top">
  <ul class="w3-navbar w3-theme w3-top w3-large">
    ...
    <li class="w3-hide-small w3-center"><a href="backEndMain.php" target="main" class="w3-hover-white" style="width:100px">Home</a></li>
    <li class="w3-hide-small w3-center"><a href="customer_transaction.php" target="main" class="w3-hover-white" style="width:130px">Transaction</a></li>
