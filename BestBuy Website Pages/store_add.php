...
<form name="store_add" action="store_add_process.php" method="post">
<div class="w3-main w3-padding-64 w3-container">
    <h1 class="w3-text-teal">Fill in the new store's information</h1>
        <table class="w3-table-all" style="width:700px;">
            <tr class="w3-table-all tr">
                ...
                <th><input type=text style="width:530px;vertical-align:middle;color:#666666;" name="storeName" required></th>
            </tr>
            ...
            //storeManager
            print "<tr class=\"w3-table-all tr\">
                <th style=\"width:120px;vertical-align:middle;color:#666666;\">Store Manager</th><th>";
